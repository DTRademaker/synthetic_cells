...
test = {"002": [torch.tensor(cv2.imread(prefix  + "images/002_2.5kfps_98.png", 0)) / 255,
                    torch.tensor(cv2.imread(prefix + "images/median_real_002.png", 0)) / 255],
            "K1": [torch.tensor(cv2.imread(prefix + "images/K1_001_20201105_168.png",
                                           0)) / 255,
                   torch.tensor(cv2.imread(prefix + "images/median_real_K1.png", 0)) / 255],
            "NF": [
                torch.tensor(cv2.imread(prefix + "images/NF135_002_20201105_157.png",
                                        0)) / 255,
                torch.tensor(cv2.imread(prefix + "images/median_real_NF.png", 0)) / 255]}
